...
public class Comment extends turnkeye.pages.TestBase {
  ...
  public void testUntitled4() throws Exception {
    ...
    TimeUnit.SECONDS.sleep(5);
    assertEquals("test comment2", driver.findElement(By.id("comment")).getText());
    ...
    assertEquals("test comment2", driver.findElement(By.cssSelector("div.comment-content")).getText());
