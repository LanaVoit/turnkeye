...
public class Contact_us extends turnkeye.pages.TestBase {
  ...
  public void testUntitled6() throws Exception {
   // final WebDriver driver = new ChromeDriver();
    ...
    assertEquals("If you have any pre-sales questions or want to contact us, please use the form below. You can also submit your questions to info@turnkeye.com.", driver.findElement(By.cssSelector("h4")).getText());
