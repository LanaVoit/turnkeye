...
public class Details_elements extends turnkeye.pages.TestBase {
  ...
  public void testUntitled9() throws Exception {
    ...
    assertEquals("http://astrio.net/media/wysiwyg/portfolio/PinupClothing/xtop-banner.jpg.pagespeed.ic.aR8LmQqed2.webp", driver.findElement(By.cssSelector("#content > div.turnkeye-portfolio > div.block-portfolio-banner > img.shadows-image")).getAttribute("src"));
    assertEquals("http://astrio.net/media/wysiwyg/portfolio/PinupClothing/xtop-mobile.png.pagespeed.ic.xUAJzyVDP3.png", driver.findElement(By.xpath("//div[@id='content']/div[2]/div[3]/img[2]")).getAttribute("src"));
